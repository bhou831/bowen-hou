    ...
    <div className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-6 p-1">
        {collections.map((collection) => (
          <article key={collection.id} className="mx-auto w-full">
            <button
              type="button"
            ...
            <Link
              ...
              className="group mt-3 inline-block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-4 focus-visible:ring-offset-gray-50"
            >
